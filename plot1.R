...
# 3. Constructs the first course-project plot.
# 4. Saves it to the PNG file "plot1.png" with a width of 480 pixels and a
#    height of 480 pixels.
#
#-------------------------------------------------------------------------------
#
# main() -- The main routine that creates plot1.png
#
# ------------------------------------------------------------------------------
main <- function() {
    df <- getFilteredData() #Read and filter the data
    # todo: construct and save plot
    hplot <- hist(df$Global_active_power,
                  col = "red",
                  plot = TRUE,
